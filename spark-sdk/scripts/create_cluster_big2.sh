...
CLUSTER_NAME=dataproc-cluster-dev-big12b
...
gcloud dataproc clusters create ${CLUSTER_NAME} \
    ...
    --optional-components JUPYTER,HUDI \
...
gs://dataproc-initialization-actions/python/pip-install.sh \
    ...
    --metadata PIP_PACKAGES="numpy scipy pandas scikit-learn matplotlib seaborn graphframes eth_utils hexbytes web3 cloud-sql-python-connector[pg8000] pymysql pyspark SQLAlchemy" \
    --project mvp-infra \
